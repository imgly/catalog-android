...
// <code-region>
class VideoAddFramesFromResources(private val activity: AppCompatActivity) : Example(activity) {
    ...
    override fun invoke() {
        ...
        // When the aspect ratio of the video changes, a frame with the same group id that supports the new aspect ratio is used to replace the older frame
