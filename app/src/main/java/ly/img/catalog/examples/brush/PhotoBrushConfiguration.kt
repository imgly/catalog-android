...
// <code-region>
class PhotoBrushConfiguration(private val activity: AppCompatActivity) : Example(activity) {
    ...
    override fun invoke() {
        ...
        settingsList.configure<BrushSettings> {
            // By default the default brush size is set to 5% of the smaller side of the image
