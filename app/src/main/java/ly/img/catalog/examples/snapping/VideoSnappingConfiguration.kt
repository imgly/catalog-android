...
// <code-region>
class VideoSnappingConfiguration(private val activity: AppCompatActivity) : Example(activity) {
    ...
    override fun invoke() {
        ...
        // By default the center of the sprite snaps to a vertical line indicating the center of the video
        ...
        // By default the center of the sprite snaps to a horizontal line indicating the center of the video
        // For this example this behavior is disabled since only the outer positional snapping guides are needed
        ...
        // By default the sprite snaps to the border of the video along horizontal and vertical lines
        // This value is measured in normalized coordinates relative to the smaller side of the edited video and defaults to 5% (0.05)
        // For this example the value is set to 10% (0.1) to define the visibility area of the video.
